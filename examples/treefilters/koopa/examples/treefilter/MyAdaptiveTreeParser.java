// $ANTLR 3.1.1 examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g 2014-11-03 08:20:10

  package koopa.examples.treefilter;
...
public class MyAdaptiveTreeParser extends TreeParser {
    ...
    // delegators
        ...
        public MyAdaptiveTreeParser(TreeNodeStream input) {
            this(input, new RecognizerSharedState());
        }
        public MyAdaptiveTreeParser(TreeNodeStream input, RecognizerSharedState state) {
            super(input, state);
             
        }
        

    public String[] getTokenNames() { return MyAdaptiveTreeParser.tokenNames; }
    public String getGrammarFileName() { return "examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g"; }



    // $ANTLR start "compilationGroup"
    // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:19:1: compilationGroup : ( compilationUnit )* ;
    public final void compilationGroup() throws RecognitionException {
        try {
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:20:3: ( ( compilationUnit )* )
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:20:5: ( compilationUnit )*
            {
             System.out.println("# Adaptive Tree Parser going for a compilationGroup."); 
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:21:5: ( compilationUnit )*
            loop1:
            do {
                int alt1=2;
            	...
            	case 1 :
            	    // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:21:5: compilationUnit
            	    {
            	    pushFollow(FOLLOW_compilationUnit_in_compilationGroup62);
            	    compilationUnit();
    ...
    // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:29:1: copybook : ( paragraph )* ;
    public final void copybook() throws RecognitionException {
        try {
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:30:3: ( ( paragraph )* )
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:30:5: ( paragraph )*
            {
             System.out.println("# Adaptive Tree Parser going for a copybook."); 
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:31:5: ( paragraph )*
            loop2:
            do {
                int alt2=2;
            	...
            	case 1 :
            	    // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:31:5: paragraph
            	    {
            	    pushFollow(FOLLOW_paragraph_in_copybook92);
            	    paragraph();
    ...
    // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:39:1: compilationUnit : ^( COMPILATION_UNIT PROGRAM_NAME ( FILE_SECTION )? ( 'FILLER' )? ( declaratives )? ( paragraph | section )* ( compilationUnit )* ) ;
    public final void compilationUnit() throws RecognitionException {
        Object PROGRAM_NAME1=null;

        try {
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:40:3: ( ^( COMPILATION_UNIT PROGRAM_NAME ( FILE_SECTION )? ( 'FILLER' )? ( declaratives )? ( paragraph | section )* ( compilationUnit )* ) )
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:40:5: ^( COMPILATION_UNIT PROGRAM_NAME ( FILE_SECTION )? ( 'FILLER' )? ( declaratives )? ( paragraph | section )* ( compilationUnit )* )
            {
            match(input,COMPILATION_UNIT,FOLLOW_COMPILATION_UNIT_in_compilationUnit117); 

            match(input, Token.DOWN, null); 
            PROGRAM_NAME1=(Object)match(input,PROGRAM_NAME,FOLLOW_PROGRAM_NAME_in_compilationUnit125); 
             System.out.println("# Program " + ANTLR.getText((Tree) PROGRAM_NAME1)); 
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:44:7: ( FILE_SECTION )?
            int alt3=2;
            int LA3_0 = input.LA(1);

            if ( (LA3_0==FILE_SECTION) ) {
                alt3=1;
            }
            switch (alt3) {
                case 1 :
                    // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:44:9: FILE_SECTION
                    {
                    match(input,FILE_SECTION,FOLLOW_FILE_SECTION_in_compilationUnit150); 
            ...
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:48:7: ( 'FILLER' )?
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:48:9: 'FILLER'
                    {
                    match(input,431,FOLLOW_431_in_compilationUnit186); 
            ...
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:52:7: ( declaratives )?
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:52:8: declaratives
                    {
                    pushFollow(FOLLOW_declaratives_in_compilationUnit221);
                    declaratives();
            ...
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:54:7: ( paragraph | section )*
            loop6:
            do {
                int alt6=3;
                ...
                switch (alt6) {
            	case 1 :
            	    // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:54:9: paragraph
            	    {
            	    pushFollow(FOLLOW_paragraph_in_compilationUnit240);
            	    paragraph();
            	    ...
            	    break;
            	case 2 :
            	    // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:55:9: section
            	    {
            	    pushFollow(FOLLOW_section_in_compilationUnit250);
            	    section();
            ...
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:58:7: ( compilationUnit )*
            loop7:
            do {
                int alt7=2;
                int LA7_0 = input.LA(1);

                if ( (LA7_0==COMPILATION_UNIT) ) {
                    alt7=1;
                }
                ...
                switch (alt7) {
            	case 1 :
            	    // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:58:8: compilationUnit
            	    {
            	    pushFollow(FOLLOW_compilationUnit_in_compilationUnit275);
            	    compilationUnit();
    ...
    // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:66:1: declaratives : ^( DECLARATIVES ( SECTION_NAME )* ) ;
    public final void declaratives() throws RecognitionException {
        try {
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:67:3: ( ^( DECLARATIVES ( SECTION_NAME )* ) )
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:67:5: ^( DECLARATIVES ( SECTION_NAME )* )
            {
            match(input,DECLARATIVES,FOLLOW_DECLARATIVES_in_declaratives301); 

            if ( input.LA(1)==Token.DOWN ) {
                match(input, Token.DOWN, null); 
                // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:67:20: ( SECTION_NAME )*
                loop8:
                do {
                    int alt8=2;
                    int LA8_0 = input.LA(1);

                    if ( (LA8_0==SECTION_NAME) ) {
                        alt8=1;
                    }
                	...
                	case 1 :
                	    // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:67:20: SECTION_NAME
                	    {
                	    match(input,SECTION_NAME,FOLLOW_SECTION_NAME_in_declaratives303); 
    ...
    // $ANTLR start "section"
    // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:74:1: section : ^( SECTION SECTION_NAME ( paragraph )* ) ;
    public final void section() throws RecognitionException {
        Object SECTION_NAME2=null;

        try {
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:75:3: ( ^( SECTION SECTION_NAME ( paragraph )* ) )
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:75:5: ^( SECTION SECTION_NAME ( paragraph )* )
            {
            match(input,SECTION,FOLLOW_SECTION_in_section323); 

            match(input, Token.DOWN, null); 
            SECTION_NAME2=(Object)match(input,SECTION_NAME,FOLLOW_SECTION_NAME_in_section325); 
             System.out.println("# Section " + ANTLR.getText((Tree) SECTION_NAME2)); 
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:77:7: ( paragraph )*
            loop9:
            do {
                int alt9=2;
            	...
            	case 1 :
            	    // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:77:7: paragraph
            	    {
            	    pushFollow(FOLLOW_paragraph_in_section343);
            	    paragraph();
    ...
    // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:85:1: paragraph : ^( PARAGRAPH PARAGRAPH_NAME ) ;
    public final void paragraph() throws RecognitionException {
        Object PARAGRAPH_NAME3=null;

        try {
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:86:3: ( ^( PARAGRAPH PARAGRAPH_NAME ) )
            // examples/treefilters/koopa/examples/treefilter/MyAdaptiveTreeParser.g:86:5: ^( PARAGRAPH PARAGRAPH_NAME )
            {
            match(input,PARAGRAPH,FOLLOW_PARAGRAPH_in_paragraph368); 

            match(input, Token.DOWN, null); 
            PARAGRAPH_NAME3=(Object)match(input,PARAGRAPH_NAME,FOLLOW_PARAGRAPH_NAME_in_paragraph370); 

            match(input, Token.UP, null); 
             System.out.println("# Paragraph " + ANTLR.getText((Tree) PARAGRAPH_NAME3)); 
    ...
    public static final BitSet FOLLOW_compilationUnit_in_compilationGroup62 = new BitSet(new long[]{0x0000000000080002L});
    public static final BitSet FOLLOW_paragraph_in_copybook92 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000800000L});
    public static final BitSet FOLLOW_COMPILATION_UNIT_in_compilationUnit117 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_PROGRAM_NAME_in_compilationUnit125 = new BitSet(new long[]{0x0000000000080008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000001000000L,0x0000800000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000C80000L});
    public static final BitSet FOLLOW_FILE_SECTION_in_compilationUnit150 = new BitSet(new long[]{0x0000000000080008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000800000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000C80000L});
    public static final BitSet FOLLOW_431_in_compilationUnit186 = new BitSet(new long[]{0x0000000000080008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000C80000L});
    public static final BitSet FOLLOW_declaratives_in_compilationUnit221 = new BitSet(new long[]{0x0000000000080008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000C00000L});
    public static final BitSet FOLLOW_paragraph_in_compilationUnit240 = new BitSet(new long[]{0x0000000000080008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000C00000L});
    public static final BitSet FOLLOW_section_in_compilationUnit250 = new BitSet(new long[]{0x0000000000080008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000C00000L});
    public static final BitSet FOLLOW_compilationUnit_in_compilationUnit275 = new BitSet(new long[]{0x0000000000080008L});
    public static final BitSet FOLLOW_DECLARATIVES_in_declaratives301 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_SECTION_NAME_in_declaratives303 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000100000000L});
    ...
    public static final BitSet FOLLOW_paragraph_in_section343 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000800000L});
    public static final BitSet FOLLOW_PARAGRAPH_in_paragraph368 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_PARAGRAPH_NAME_in_paragraph370 = new BitSet(new long[]{0x0000000000000008L});
