...
import koopa.cobol.util.CobolSupport;
...
public class TreeFilterSample {
	...
	public static void main(String[] args) throws IOException {
		...
		File target = new File("testsuite/cobol85");

		File[] sources = getSources(target);
	...
	private static File[] getSources(File root) {
		if (root.isDirectory())
			return root.listFiles(CobolSupport.getFilenameFilter());
		else
