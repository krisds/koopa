// $ANTLR 3.1.1 src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g 2014-11-24 20:28:28
...
public class CobolOutlineTreeParser extends TreeParser {
    ...
    // delegators
        ...
        public CobolOutlineTreeParser(TreeNodeStream input) {
            this(input, new RecognizerSharedState());
        }
        public CobolOutlineTreeParser(TreeNodeStream input, RecognizerSharedState state) {
            super(input, state);
             
        }
        

    public String[] getTokenNames() { return CobolOutlineTreeParser.tokenNames; }
    public String getGrammarFileName() { return "src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g"; }
    ...
    // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:60:1: compilationGroup : ( compilationUnit )* ;
    public final void compilationGroup() throws RecognitionException {
        try {
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:61:3: ( ( compilationUnit )* )
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:61:5: ( compilationUnit )*
            {
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:61:5: ( compilationUnit )*
            loop1:
            do {
    ...
    // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:64:1: copybook : ( paragraph )* ;
    public final void copybook() throws RecognitionException {
        try {
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:65:3: ( ( paragraph )* )
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:65:5: ( paragraph )*
            {
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:65:5: ( paragraph )*
            loop2:
            do {
    ...
    // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:68:1: compilationUnit : ^( COMPILATION_UNIT PROGRAM_NAME ( procedureDivision ( compilationUnit )* )? ) ;
    public final void compilationUnit() throws RecognitionException {
        Object COMPILATION_UNIT1=null;
        Object PROGRAM_NAME2=null;

        try {
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:69:3: ( ^( COMPILATION_UNIT PROGRAM_NAME ( procedureDivision ( compilationUnit )* )? ) )
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:69:5: ^( COMPILATION_UNIT PROGRAM_NAME ( procedureDivision ( compilationUnit )* )? )
            {
            COMPILATION_UNIT1=(Object)match(input,COMPILATION_UNIT,FOLLOW_COMPILATION_UNIT_in_compilationUnit87); 

            match(input, Token.DOWN, null); 
            PROGRAM_NAME2=(Object)match(input,PROGRAM_NAME,FOLLOW_PROGRAM_NAME_in_compilationUnit89); 
             push(new Reference((Tree) COMPILATION_UNIT1,
                                       ANTLR.getText((Tree) PROGRAM_NAME2), PROGRAM_ICON)); 
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:73:7: ( procedureDivision ( compilationUnit )* )?
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:73:9: procedureDivision ( compilationUnit )*
                    {
                    pushFollow(FOLLOW_procedureDivision_in_compilationUnit108);
                    procedureDivision();

                    state._fsp--;

                    // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:74:9: ( compilationUnit )*
                    loop3:
                    do {
                        int alt3=2;
                    	...
                    	case 1 :
                    	    // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:74:9: compilationUnit
                    	    {
                    	    pushFollow(FOLLOW_compilationUnit_in_compilationUnit124);
                    	    compilationUnit();
    ...
    // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:80:1: procedureDivision : ^( PROCEDURE_DIVISION ( declaratives )? ( paragraph | section )* ) ;
    public final void procedureDivision() throws RecognitionException {
        try {
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:81:3: ( ^( PROCEDURE_DIVISION ( declaratives )? ( paragraph | section )* ) )
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:81:5: ^( PROCEDURE_DIVISION ( declaratives )? ( paragraph | section )* )
            {
            match(input,PROCEDURE_DIVISION,FOLLOW_PROCEDURE_DIVISION_in_procedureDivision162); 

            if ( input.LA(1)==Token.DOWN ) {
                match(input, Token.DOWN, null); 
                // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:83:7: ( declaratives )?
                int alt5=2;
                ...
                switch (alt5) {
                    case 1 :
                        // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:83:8: declaratives
                        {
                        pushFollow(FOLLOW_declaratives_in_procedureDivision172);
                        declaratives();
                ...
                // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:85:7: ( paragraph | section )*
                loop6:
                do {
                    int alt6=3;
                    ...
                    switch (alt6) {
                	case 1 :
                	    // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:85:9: paragraph
                	    {
                	    pushFollow(FOLLOW_paragraph_in_procedureDivision191);
                	    paragraph();
                	    ...
                	    break;
                	case 2 :
                	    // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:86:9: section
                	    {
                	    pushFollow(FOLLOW_section_in_procedureDivision201);
                	    section();
    ...
    // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:91:1: declaratives : ^( DECLARATIVES ( declarativeSection )* ) ;
    public final void declaratives() throws RecognitionException {
        Object DECLARATIVES3=null;

        try {
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:92:3: ( ^( DECLARATIVES ( declarativeSection )* ) )
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:92:5: ^( DECLARATIVES ( declarativeSection )* )
            {
            DECLARATIVES3=(Object)match(input,DECLARATIVES,FOLLOW_DECLARATIVES_in_declaratives230); 

             push(new Reference((Tree) DECLARATIVES3, "DECLARATIVES", DECLARATIVES_ICON)); 

            if ( input.LA(1)==Token.DOWN ) {
                match(input, Token.DOWN, null); 
                // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:94:7: ( declarativeSection )*
                loop7:
                do {
                    int alt7=2;
                	...
                	case 1 :
                	    // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:94:7: declarativeSection
                	    {
                	    pushFollow(FOLLOW_declarativeSection_in_declaratives246);
                	    declarativeSection();
    ...
    // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:99:1: declarativeSection : ^( DECLARATIVE_SECTION SECTION_NAME ( paragraph )* ) ;
    public final void declarativeSection() throws RecognitionException {
        Object DECLARATIVE_SECTION4=null;
        Object SECTION_NAME5=null;

        try {
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:100:3: ( ^( DECLARATIVE_SECTION SECTION_NAME ( paragraph )* ) )
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:100:5: ^( DECLARATIVE_SECTION SECTION_NAME ( paragraph )* )
            {
            DECLARATIVE_SECTION4=(Object)match(input,DECLARATIVE_SECTION,FOLLOW_DECLARATIVE_SECTION_in_declarativeSection276); 

            match(input, Token.DOWN, null); 
            SECTION_NAME5=(Object)match(input,SECTION_NAME,FOLLOW_SECTION_NAME_in_declarativeSection278); 
             push(new Reference((Tree) DECLARATIVE_SECTION4,
                                       ANTLR.getText((Tree) SECTION_NAME5), SECTION_ICON)); 
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:103:7: ( paragraph )*
            loop8:
            do {
                int alt8=2;
            	...
            	case 1 :
            	    // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:103:7: paragraph
            	    {
            	    pushFollow(FOLLOW_paragraph_in_declarativeSection294);
            	    paragraph();
    ...
    // $ANTLR start "section"
    // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:108:1: section : ^( SECTION SECTION_NAME ( paragraph )* ) ;
    public final void section() throws RecognitionException {
        Object SECTION6=null;
        Object SECTION_NAME7=null;

        try {
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:109:3: ( ^( SECTION SECTION_NAME ( paragraph )* ) )
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:109:5: ^( SECTION SECTION_NAME ( paragraph )* )
            {
            SECTION6=(Object)match(input,SECTION,FOLLOW_SECTION_in_section323); 

            match(input, Token.DOWN, null); 
            SECTION_NAME7=(Object)match(input,SECTION_NAME,FOLLOW_SECTION_NAME_in_section325); 
             push(new Reference((Tree) SECTION6,
                                        ANTLR.getText((Tree) SECTION_NAME7), SECTION_ICON)); 
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:112:7: ( paragraph )*
            loop9:
            do {
                int alt9=2;
    ...
    // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:117:1: paragraph : ^( PARAGRAPH PARAGRAPH_NAME ) ;
    public final void paragraph() throws RecognitionException {
        Object PARAGRAPH8=null;
        Object PARAGRAPH_NAME9=null;

        try {
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:118:3: ( ^( PARAGRAPH PARAGRAPH_NAME ) )
            // src/apps/koopa/app/components/outline/CobolOutlineTreeParser.g:118:5: ^( PARAGRAPH PARAGRAPH_NAME )
            {
            PARAGRAPH8=(Object)match(input,PARAGRAPH,FOLLOW_PARAGRAPH_in_paragraph370); 

            match(input, Token.DOWN, null); 
            PARAGRAPH_NAME9=(Object)match(input,PARAGRAPH_NAME,FOLLOW_PARAGRAPH_NAME_in_paragraph372); 

            match(input, Token.UP, null); 
             push(new Reference((Tree) PARAGRAPH8,
                                      ANTLR.getText((Tree) PARAGRAPH_NAME9), PARAGRAPH_ICON)); 
             pop(); 
    ...
    public static final BitSet FOLLOW_compilationUnit_in_compilationGroup58 = new BitSet(new long[]{0x0000800000000002L});
    public static final BitSet FOLLOW_paragraph_in_copybook72 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000200000000000L});
    public static final BitSet FOLLOW_COMPILATION_UNIT_in_compilationUnit87 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_PROGRAM_NAME_in_compilationUnit89 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000008000000L});
    public static final BitSet FOLLOW_procedureDivision_in_compilationUnit108 = new BitSet(new long[]{0x0000800000000008L});
    public static final BitSet FOLLOW_compilationUnit_in_compilationUnit124 = new BitSet(new long[]{0x0000800000000008L});
    public static final BitSet FOLLOW_PROCEDURE_DIVISION_in_procedureDivision162 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_declaratives_in_procedureDivision172 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000300000000000L});
    public static final BitSet FOLLOW_paragraph_in_procedureDivision191 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000300000000000L});
    public static final BitSet FOLLOW_section_in_procedureDivision201 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000300000000000L});
    public static final BitSet FOLLOW_DECLARATIVES_in_declaratives230 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_declarativeSection_in_declaratives246 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_DECLARATIVE_SECTION_in_declarativeSection276 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_SECTION_NAME_in_declarativeSection278 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000200000000000L});
    public static final BitSet FOLLOW_paragraph_in_declarativeSection294 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000200000000000L});
    public static final BitSet FOLLOW_SECTION_in_section323 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_SECTION_NAME_in_section325 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000200000000000L});
    public static final BitSet FOLLOW_paragraph_in_section341 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000200000000000L});
    public static final BitSet FOLLOW_PARAGRAPH_in_paragraph370 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_PARAGRAPH_NAME_in_paragraph372 = new BitSet(new long[]{0x0000000000000008L});
