...
public class KGLexer extends Lexer {
	...
	public final void mCOMMENT() throws RecognitionException {
		try {
			int _type = COMMENT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:208:9: ( '#' (~ ( '\\n' | '\\r' ) )* )
			// src/core/koopa/core/grammars/generator/KG.g:208:11: '#' (~ ( '\\n' | '\\r' ) )*
			{
			match('#'); if (state.failed) return;
			// src/core/koopa/core/grammars/generator/KG.g:208:15: (~ ( '\\n' | '\\r' ) )*
			loop1:
			while (true) {
				int alt1=2;
	...
	public final void mNEWLINE() throws RecognitionException {
		try {
			int _type = NEWLINE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:210:9: ( ( ( '\\r\\n' )=> '\\r\\n' | '\\r' | '\\n' ) )
			// src/core/koopa/core/grammars/generator/KG.g:210:11: ( ( '\\r\\n' )=> '\\r\\n' | '\\r' | '\\n' )
			{
			// src/core/koopa/core/grammars/generator/KG.g:210:11: ( ( '\\r\\n' )=> '\\r\\n' | '\\r' | '\\n' )
			int alt2=3;
			...
			switch (alt2) {
				case 1 :
					// src/core/koopa/core/grammars/generator/KG.g:210:13: ( '\\r\\n' )=> '\\r\\n'
					{
					...
					break;
				case 2 :
					// src/core/koopa/core/grammars/generator/KG.g:210:34: '\\r'
					{
					match('\r'); if (state.failed) return;
					}
					break;
				case 3 :
					// src/core/koopa/core/grammars/generator/KG.g:210:41: '\\n'
					{
					match('\n'); if (state.failed) return;
					}
					break;
	...
	public final void mPRIVATE() throws RecognitionException {
		try {
			int _type = PRIVATE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:212:9: ( 'private' )
			// src/core/koopa/core/grammars/generator/KG.g:212:11: 'private'
			{
	...
	public final void mPUBLIC() throws RecognitionException {
		try {
			int _type = PUBLIC;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:213:9: ( 'public' )
			// src/core/koopa/core/grammars/generator/KG.g:213:11: 'public'
			{
	...
	public final void mNOSKIP() throws RecognitionException {
		try {
			int _type = NOSKIP;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:215:9: ( '%noskip' )
			// src/core/koopa/core/grammars/generator/KG.g:215:11: '%noskip'
			{
	...
	public final void mLIMIT() throws RecognitionException {
		try {
			int _type = LIMIT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:216:9: ( '%limit' )
			// src/core/koopa/core/grammars/generator/KG.g:216:11: '%limit'
			{
	...
	public final void mBY() throws RecognitionException {
		try {
			int _type = BY;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:217:9: ( '%by' )
			// src/core/koopa/core/grammars/generator/KG.g:217:11: '%by'
			{
	...
	public final void mAS() throws RecognitionException {
		try {
			int _type = AS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:218:9: ( '%as' )
			// src/core/koopa/core/grammars/generator/KG.g:218:11: '%as'
			{
	...
	public final void mNOT() throws RecognitionException {
		try {
			int _type = NOT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:219:9: ( '%not' )
			// src/core/koopa/core/grammars/generator/KG.g:219:11: '%not'
			{
	...
	public final void mARROW() throws RecognitionException {
		try {
			int _type = ARROW;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:221:9: ( '=>' )
			// src/core/koopa/core/grammars/generator/KG.g:221:11: '=>'
			{
			match("=>"); if (state.failed) return;
	...
	public final void mTAG() throws RecognitionException {
		try {
			int _type = TAG;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:223:5: ( '@' LETTER ( LETTER | DIGIT | '-' | '_' )* )
			// src/core/koopa/core/grammars/generator/KG.g:223:7: '@' LETTER ( LETTER | DIGIT | '-' | '_' )*
			{
			match('@'); if (state.failed) return;
			mLETTER(); if (state.failed) return;

			// src/core/koopa/core/grammars/generator/KG.g:223:18: ( LETTER | DIGIT | '-' | '_' )*
			loop3:
			while (true) {
				int alt3=2;
	...
	public final void mANY() throws RecognitionException {
		try {
			int _type = ANY;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:225:5: ( '_' )
			// src/core/koopa/core/grammars/generator/KG.g:225:7: '_'
			{
	...
	public final void mIDENTIFIER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:227:12: ( LOWERCASE ( LETTER | DIGIT | '-' | '_' )* )
			// src/core/koopa/core/grammars/generator/KG.g:227:14: LOWERCASE ( LETTER | DIGIT | '-' | '_' )*
			{
			mLOWERCASE(); if (state.failed) return;

			// src/core/koopa/core/grammars/generator/KG.g:227:24: ( LETTER | DIGIT | '-' | '_' )*
			loop4:
			while (true) {
				int alt4=2;
	...
	public final void mTOKEN() throws RecognitionException {
		try {
			int _type = TOKEN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:228:12: ( UPPERCASE ( LETTER | DIGIT | '-' | '_' )* )
			// src/core/koopa/core/grammars/generator/KG.g:228:14: UPPERCASE ( LETTER | DIGIT | '-' | '_' )*
			{
			mUPPERCASE(); if (state.failed) return;

			// src/core/koopa/core/grammars/generator/KG.g:228:24: ( LETTER | DIGIT | '-' | '_' )*
			loop5:
			while (true) {
				int alt5=2;
	...
	public final void mLITERAL() throws RecognitionException {
		try {
			...
			{
			match('\''); if (state.failed) return;
			// src/core/koopa/core/grammars/generator/KG.g:230:16: (~ ( '\\'' | '\\n' | '\\r' ) )+
			int cnt6=0;
			loop6:
			while (true) {
				int alt6=2;
	...
	public final void mNUMBER() throws RecognitionException {
		try {
			int _type = NUMBER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:232:8: ( ( DIGIT )+ )
			// src/core/koopa/core/grammars/generator/KG.g:232:10: ( DIGIT )+
			{
			// src/core/koopa/core/grammars/generator/KG.g:232:10: ( DIGIT )+
			int cnt7=0;
			loop7:
	...
	public final void mWHITESPACE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:234:12: ( ( ' ' | '\\t' )+ )
			// src/core/koopa/core/grammars/generator/KG.g:234:14: ( ' ' | '\\t' )+
			{
			// src/core/koopa/core/grammars/generator/KG.g:234:14: ( ' ' | '\\t' )+
			int cnt8=0;
			loop8:
	...
	public final void mEQUALS() throws RecognitionException {
		try {
			int _type = EQUALS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:236:8: ( '=' )
			// src/core/koopa/core/grammars/generator/KG.g:236:10: '='
			{
			match('='); if (state.failed) return;
			}
	...
	public final void mOPEN_PAREN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:238:12: ( '(' )
			// src/core/koopa/core/grammars/generator/KG.g:238:14: '('
			{
			match('('); if (state.failed) return;
			}
	...
	public final void mCLOSE_PAREN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:240:13: ( ')' )
			// src/core/koopa/core/grammars/generator/KG.g:240:15: ')'
			{
			match(')'); if (state.failed) return;
			}
	...
	public final void mOPEN_BRACKET() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:242:14: ( '[' )
			// src/core/koopa/core/grammars/generator/KG.g:242:16: '['
			{
			match('['); if (state.failed) return;
			}
	...
	public final void mCLOSE_BRACKET() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:244:15: ( ']' )
			// src/core/koopa/core/grammars/generator/KG.g:244:17: ']'
			{
			match(']'); if (state.failed) return;
			}
	...
	public final void mNATIVE_CODE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:248:13: ( '{' (~ '}' )* '}' )
			// src/core/koopa/core/grammars/generator/KG.g:248:15: '{' (~ '}' )* '}'
			{
			match('{'); if (state.failed) return;
			// src/core/koopa/core/grammars/generator/KG.g:248:19: (~ '}' )*
			loop9:
			while (true) {
				int alt9=2;
	...
	public final void mSTAR() throws RecognitionException {
		try {
			int _type = STAR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:250:6: ( '*' )
			// src/core/koopa/core/grammars/generator/KG.g:250:8: '*'
			{
			match('*'); if (state.failed) return;
			}
	...
	public final void mPLUS() throws RecognitionException {
		try {
			int _type = PLUS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:252:6: ( '+' )
			// src/core/koopa/core/grammars/generator/KG.g:252:8: '+'
			{
			match('+'); if (state.failed) return;
			}
	...
	public final void mWITH() throws RecognitionException {
		try {
			int _type = WITH;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:254:6: ( '---' )
			// src/core/koopa/core/grammars/generator/KG.g:254:8: '---'
			{
			match("---"); if (state.failed) return;
	...
	public final void mSKIP_TO() throws RecognitionException {
		try {
			int _type = SKIP_TO;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:255:9: ( '-->' )
			// src/core/koopa/core/grammars/generator/KG.g:255:11: '-->'
			{
			match("-->"); if (state.failed) return;
	...
	public final void mPIPE() throws RecognitionException {
		try {
			int _type = PIPE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:259:6: ( '|' )
			// src/core/koopa/core/grammars/generator/KG.g:259:8: '|'
			{
			match('|'); if (state.failed) return;
			}
	...
	public final void mCOMMA() throws RecognitionException {
		try {
			int _type = COMMA;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:261:7: ( ',' )
			// src/core/koopa/core/grammars/generator/KG.g:261:9: ','
			{
			match(','); if (state.failed) return;
			}
	...
	public final void mBANG() throws RecognitionException {
		try {
			int _type = BANG;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:263:6: ( '!' )
			// src/core/koopa/core/grammars/generator/KG.g:263:8: '!'
			{
			match('!'); if (state.failed) return;
			}
	...
	public final void mDOLLAR() throws RecognitionException {
		try {
			int _type = DOLLAR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/core/koopa/core/grammars/generator/KG.g:265:8: ( '$' )
			// src/core/koopa/core/grammars/generator/KG.g:265:10: '$'
			{
			match('$'); if (state.failed) return;
			}
	...
	public final void mCOLON() throws RecognitionException {
		try {
			...
			// src/core/koopa/core/grammars/generator/KG.g:267:9: ':'
			{
			match(':'); if (state.failed) return;
			}
	...
	public final void mLETTER() throws RecognitionException {
		try {
			// src/core/koopa/core/grammars/generator/KG.g:269:20: ( LOWERCASE | UPPERCASE )
			// src/core/koopa/core/grammars/generator/KG.g:
			{
	...
	public final void mLOWERCASE() throws RecognitionException {
		try {
			// src/core/koopa/core/grammars/generator/KG.g:270:20: ( 'a' .. 'z' )
			// src/core/koopa/core/grammars/generator/KG.g:
			{
	...
	public final void mUPPERCASE() throws RecognitionException {
		try {
			// src/core/koopa/core/grammars/generator/KG.g:271:20: ( 'A' .. 'Z' )
			// src/core/koopa/core/grammars/generator/KG.g:
			{
			if ( (input.LA(1) >= 'A' && input.LA(1) <= 'Z') ) {
				input.consume();
	...
	public final void mDIGIT() throws RecognitionException {
		try {
			// src/core/koopa/core/grammars/generator/KG.g:272:20: ( '0' .. '9' )
			// src/core/koopa/core/grammars/generator/KG.g:
			{
			if ( (input.LA(1) >= '0' && input.LA(1) <= '9') ) {
				input.consume();
	...
	public void mTokens() throws RecognitionException {
		// src/core/koopa/core/grammars/generator/KG.g:1:8: ( T__59 | T__60 | T__61 | T__62 | T__63 | T__64 | COMMENT | NEWLINE | PRIVATE | PUBLIC | NOSKIP | LIMIT | BY | AS | NOT | ARROW | TAG | ANY | IDENTIFIER | TOKEN | LITERAL | NUMBER | WHITESPACE | EQUALS | OPEN_PAREN | CLOSE_PAREN | OPEN_BRACKET | CLOSE_BRACKET | NATIVE_CODE | STAR | PLUS | WITH | SKIP_TO | DOT | PIPE | COMMA | BANG | DOLLAR | COLON )
		int alt10=39;
		alt10 = dfa10.predict(input);
		switch (alt10) {
			case 1 :
				// src/core/koopa/core/grammars/generator/KG.g:1:10: T__59
				{
				...
				break;
			case 2 :
				// src/core/koopa/core/grammars/generator/KG.g:1:16: T__60
				{
				...
				break;
			case 3 :
				// src/core/koopa/core/grammars/generator/KG.g:1:22: T__61
				{
				...
				break;
			case 4 :
				// src/core/koopa/core/grammars/generator/KG.g:1:28: T__62
				{
				...
				break;
			case 5 :
				// src/core/koopa/core/grammars/generator/KG.g:1:34: T__63
				{
				...
				break;
			case 6 :
				// src/core/koopa/core/grammars/generator/KG.g:1:40: T__64
				{
			...
			case 38 :
				...
				break;
			case 39 :
				// src/core/koopa/core/grammars/generator/KG.g:1:276: COLON
				{
	...
	public final void synpred1_KG_fragment() throws RecognitionException {
		// src/core/koopa/core/grammars/generator/KG.g:210:13: ( '\\r\\n' )
		// src/core/koopa/core/grammars/generator/KG.g:210:14: '\\r\\n'
		{
		match("\r\n"); if (state.failed) return;
	...
	static final String DFA10_eotS =
		"\1\uffff\5\15\2\uffff\1\15\1\uffff\1\55\25\uffff\10\15\7\uffff\1\72\1"+
		"\73\6\15\5\uffff\3\15\1\107\2\15\2\uffff\3\15\1\uffff\6\15\1\123\1\124"+
		"\1\125\1\126\1\127\5\uffff";
	static final String DFA10_eofS =
		"\130\uffff";
	static final String DFA10_minS =
		"\1\11\1\145\1\156\1\162\1\145\1\162\2\uffff\1\162\1\141\1\76\16\uffff"+
		"\1\55\6\uffff\1\146\1\144\1\164\1\141\1\164\1\145\1\151\1\142\1\157\5"+
	...
	static final String DFA10_acceptS =
		...
		"\1\33\1\34\1\35\1\36\1\37\1\uffff\1\42\1\43\1\44\1\45\1\46\1\47\11\uffff"+
		"\1\14\1\15\1\16\1\20\1\30\12\uffff\1\40\1\41\1\1\1\2\6\uffff\1\13\1\17"+
		"\3\uffff\1\6\13\uffff\1\12\1\3\1\4\1\5\1\11";
	static final String DFA10_specialS =
		"\130\uffff}>";
	static final String[] DFA10_transitionS = {
			"\1\21\1\7\2\uffff\1\7\22\uffff\1\21\1\35\1\uffff\1\6\1\36\1\11\1\uffff"+
			"\1\17\1\22\1\23\1\27\1\30\1\34\1\31\1\32\1\uffff\12\20\1\37\2\uffff\1"+
			"\12\2\uffff\1\13\32\16\1\24\1\uffff\1\25\1\uffff\1\14\1\uffff\3\15\1"+
			"\1\1\2\1\15\1\3\10\15\1\10\1\15\1\4\1\15\1\5\6\15\1\26\1\33",
			"\1\40",
			"\1\41\11\uffff\1\42",
			"\1\43",
			"\1\44",
	...
	protected class DFA10 extends DFA {
		...
		public String getDescription() {
			return "1:1: Tokens : ( T__59 | T__60 | T__61 | T__62 | T__63 | T__64 | COMMENT | NEWLINE | PRIVATE | PUBLIC | NOSKIP | LIMIT | BY | AS | NOT | ARROW | TAG | ANY | IDENTIFIER | TOKEN | LITERAL | NUMBER | WHITESPACE | EQUALS | OPEN_PAREN | CLOSE_PAREN | OPEN_BRACKET | CLOSE_BRACKET | NATIVE_CODE | STAR | PLUS | WITH | SKIP_TO | DOT | PIPE | COMMA | BANG | DOLLAR | COLON );";
		}
	}
