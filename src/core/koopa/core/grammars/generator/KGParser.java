...
public class KGParser extends Parser {
	...
	public final KGParser.rule_return rule() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: sequence, sequence, locals, r, sequence, i, i, r, i, i, locals, sequence
			// token labels: r, i
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
		...
		try {
			...
			switch (alt16) {
				...
				case 8 :
					...
					// AST REWRITE
					// elements: r, more, sequence, sequence, more, sequence, r, sequence
					// token labels: r
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 9 :
					...
					// AST REWRITE
					// elements: r, sequence, more, sequence, sequence, r, more, sequence
					// token labels: r
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
