// $ANTLR 3.5.2 src/core/koopa/core/grammars/test/generator/StageGenerator.g
...
public class StageGenerator extends TreeParser {
	...
	@Override public String[] getTokenNames() { return StageGenerator.tokenNames; }
	@Override public String getGrammarFileName() { return "src/core/koopa/core/grammars/test/generator/StageGenerator.g"; }
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					tests.addAll((t!=null?((StageGenerator.testsForGrammarRule_return)t).tests:null));
					}
					break;
			...
			{
				retval.st = templateLib.getInstanceOf("stage",new STAttrMap().put("name", name).put("date", new Date()).put("package", p).put("grammah", g).put("tokenizer", tok).put("test", tests));
			}
			...
			while (true) {
				...
				case 1 :
					...
					state._fsp--;
					 ...
					 retval.tests.add((t!=null?((StringTemplate)t.getTemplate()):null)); 
					}
					break;
	...
	public final StageGenerator.test_return test(String target) throws RecognitionException {
		...
		try {
			...
			if (accept) {
				retval.st = templateLib.getInstanceOf("accept",new STAttrMap().put("name", name).put("number", ++count).put("target", target).put("token", data));
			}

			else // 96:5: -> reject(name=namenumber=++counttarget=targettoken=data)
			{
				retval.st = templateLib.getInstanceOf("reject",new STAttrMap().put("name", name).put("number", ++count).put("target", target).put("token", data));
			}
	...
	public static final BitSet FOLLOW_pack_in_stage81 = new BitSet(new long[]{0x0000000000000080L});
	public static final BitSet FOLLOW_grammah_in_stage85 = new BitSet(new long[]{0x0000000000080000L});
	public static final BitSet FOLLOW_tokenizer_in_stage89 = new BitSet(new long[]{0x0000000000020008L});
	public static final BitSet FOLLOW_testsForGrammarRule_in_stage100 = new BitSet(new long[]{0x0000000000020008L});
	...
	public static final BitSet FOLLOW_IDENTIFIER_in_testsForGrammarRule330 = new BitSet(new long[]{0x0000000000040008L});
	public static final BitSet FOLLOW_test_in_testsForGrammarRule343 = new BitSet(new long[]{0x0000000000040008L});
	public static final BitSet FOLLOW_TEST_in_test389 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_ACCEPT_in_test414 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_REJECT_in_test424 = new BitSet(new long[]{0x0000000000000040L});
