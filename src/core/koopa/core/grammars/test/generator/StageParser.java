// $ANTLR 3.1.1 src/core/koopa/core/grammars/test/generator/Stage.g
...
public class StageParser extends Parser {
    ...
    public final StageParser.stage_return stage() throws RecognitionException {
        ...
        StageParser.tokenizerDeclaration_return tokenizerDeclaration3 = null;

        StageParser.testsForGrammarRule_return testsForGrammarRule4 = null;
        ...
        try {
            ...
            // AST REWRITE
            // elements: grammarDeclaration, packageDeclaration, testsForGrammarRule, tokenizerDeclaration
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final StageParser.tokenizerDeclaration_return tokenizerDeclaration() throws RecognitionException {
        ...
        try {
            ...
            {
            string_literal12=(Token)match(input,23,FOLLOW_23_in_tokenizerDeclaration197);  
            stream_23.add(string_literal12);
    ...
    public final StageParser.testsForGrammarRule_return testsForGrammarRule() throws RecognitionException {
        ...
        Token SEMI17=null;
        StageParser.testcase_return testcase18 = null;
        ...
        try {
            ...
            {
            string_literal15=(Token)match(input,24,FOLLOW_24_in_testsForGrammarRule227);  
            stream_24.add(string_literal15);
    ...
    public static final BitSet FOLLOW_grammarDeclaration_in_stage85 = new BitSet(new long[]{0x0000000000800000L});
    public static final BitSet FOLLOW_tokenizerDeclaration_in_stage91 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_testsForGrammarRule_in_stage97 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_EOF_in_stage104 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_21_in_grammarDeclaration137 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_IDENTIFIER_in_grammarDeclaration139 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_SEMI_in_grammarDeclaration141 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_22_in_packageDeclaration167 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_IDENTIFIER_in_packageDeclaration169 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_SEMI_in_packageDeclaration171 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_23_in_tokenizerDeclaration197 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_IDENTIFIER_in_tokenizerDeclaration199 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_SEMI_in_tokenizerDeclaration201 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_24_in_testsForGrammarRule227 = new BitSet(new long[]{0x0000000000000400L});
    public static final BitSet FOLLOW_IDENTIFIER_in_testsForGrammarRule229 = new BitSet(new long[]{0x0000000000000800L});
    public static final BitSet FOLLOW_SEMI_in_testsForGrammarRule231 = new BitSet(new long[]{0x0000000000003002L});
    public static final BitSet FOLLOW_testcase_in_testsForGrammarRule237 = new BitSet(new long[]{0x0000000000003002L});
    public static final BitSet FOLLOW_ACCEPT_in_testcase270 = new BitSet(new long[]{0x0000000000004000L});
    public static final BitSet FOLLOW_REJECT_in_testcase276 = new BitSet(new long[]{0x0000000000004000L});
