// $ANTLR 3.5.2 src/core/koopa/core/grammars/test/generator/StageTreeParser.g
...
public class StageTreeParser extends TreeParser {
	...
	@Override public String[] getTokenNames() { return StageTreeParser.tokenNames; }
	@Override public String getGrammarFileName() { return "src/core/koopa/core/grammars/test/generator/StageTreeParser.g"; }
	...
	public static final BitSet FOLLOW_pack_in_stage61 = new BitSet(new long[]{0x0000000000000080L});
	public static final BitSet FOLLOW_grammah_in_stage63 = new BitSet(new long[]{0x0000000000080000L});
	public static final BitSet FOLLOW_tokenizer_in_stage65 = new BitSet(new long[]{0x0000000000020008L});
	public static final BitSet FOLLOW_testsForGrammarRule_in_stage67 = new BitSet(new long[]{0x0000000000020008L});
	...
	public static final BitSet FOLLOW_IDENTIFIER_in_testsForGrammarRule138 = new BitSet(new long[]{0x0000000000040008L});
	public static final BitSet FOLLOW_test_in_testsForGrammarRule140 = new BitSet(new long[]{0x0000000000040008L});
	public static final BitSet FOLLOW_TEST_in_test158 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_set_in_test160 = new BitSet(new long[]{0x0000000000000040L});
