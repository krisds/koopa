// $ANTLR 3.1.1 src/core/koopa/core/treegrammars/generator/TreeGrammarGenerator.g 2015-02-03 15:37:15
...
public class TreeGrammarGenerator extends TreeParser {
    ...
    public String[] getTokenNames() { return TreeGrammarGenerator.tokenNames; }
    public String getGrammarFileName() { return "src/core/koopa/core/treegrammars/generator/TreeGrammarGenerator.g"; }
    ...
    public final TreeGrammarGenerator.koopa_return koopa(Properties p, String imports) throws RecognitionException {
        ...
        try {
            ...
            // 33:5: -> treegrammar(name=p.getProperty(\"named\")extending=p.getProperty(\"extending\")date=new Date()package=p.getProperty(\"package\")imports=importsrule=$r)
            {
              ...
              new STAttrMap().put("name", p.getProperty("named")).put("extending", p.getProperty("extending")).put("date", new Date()).put("package", p.getProperty("package")).put("imports", imports).put("rule", list_r));
            }
    ...
    public final TreeGrammarGenerator.meta_return meta(Properties meta) throws RecognitionException {
        ...
        TreeGrammarGenerator.named_return n = null;

        TreeGrammarGenerator.extending_return e = null;
    ...
    public final TreeGrammarGenerator.rule_return rule() throws RecognitionException {
        ...
        CommonTree n=null;
        TreeGrammarGenerator.locals_return l = null;

        TreeGrammarGenerator.returning_return r = null;
    ...
    public final TreeGrammarGenerator.locals_return locals() throws RecognitionException {
        ...
        TreeGrammarGenerator.declaration_return d = null;
            ...
            switch (alt11) {
                ...
                case 2 :
                    ...
                    // 151:5: -> apply(bind=bindingsunbind=unbindingsnative_code=n)
                    {
                      ...
                      new STAttrMap().put("bind", bindings).put("unbind", unbindings).put("native_code", n));
                    }
                ...
                case 12 :
                    ...
                    break;
                case 13 :
                    // src/core/koopa/core/treegrammars/generator/TreeGrammarGenerator.g:238:5: ^( OPTIONAL b= body[bindings, unbindings] )
                    {
                    match(input,OPTIONAL,FOLLOW_OPTIONAL_in_body1146); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_body_in_body1156);
                    b=body(bindings, unbindings);
                ...
                case 14 :
                    ...
                    {
                    match(input,SKIP_TO,FOLLOW_SKIP_TO_in_body1207); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_body_in_body1215);
                    body(bindings, unbindings);
                ...
                case 15 :
                    ...
                    {
                    match(input,NOT,FOLLOW_NOT_in_body1232); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_body_in_body1234);
                    body(bindings, unbindings);
                ...
                case 16 :
                    ...
                    {
                    match(input,NOSKIP,FOLLOW_NOSKIP_in_body1244); 
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    pushFollow(FOLLOW_body_in_body1254);
                    	    body(bindings, unbindings);
                ...
                case 17 :
                    ...
                    {
                    match(input,PERMUTED,FOLLOW_PERMUTED_in_body1282); 
    ...
    public static final BitSet FOLLOW_declaration_in_locals522 = new BitSet(new long[]{0x0000000000080008L});
    ...
    public static final BitSet FOLLOW_IDENTIFIER_in_body931 = new BitSet(new long[]{0x0000000140C00000L});
    ...
    public static final BitSet FOLLOW_body_in_body1156 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_SKIP_TO_in_body1207 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_body_in_body1215 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NOT_in_body1232 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_body_in_body1234 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NOSKIP_in_body1244 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_body_in_body1254 = new BitSet(new long[]{0x00000327E0F73808L});
    public static final BitSet FOLLOW_PERMUTED_in_body1282 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_body_in_body1292 = new BitSet(new long[]{0x00000327E0F73808L});
