...
public class ANTLRv3Parser extends Parser {
    ...
    public final ANTLRv3Parser.grammarDef_return grammarDef() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: attrScope, rule, id, DOC_COMMENT, action, optionsSpec, tokensSpec
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final ANTLRv3Parser.action_return action() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: actionScopeName, id, ACTION, 72
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final ANTLRv3Parser.rule_return rule() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: ruleAction, exceptionGroup, ruleScopeSpec, optionsSpec, rt, id, altList, arg
            // token labels: arg, rt
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
                ...
                case 1 :
                    ...
                    switch (alt40) {
                        case 1 :
                            ...
                            // AST REWRITE
                            // elements: labelOp, atom, id, ebnfSuffix
        ...
        try {
            ...
            switch (alt54) {
                ...
                case 4 :
                    ...
                    // AST REWRITE
                    // elements: RULE_REF, RULE_REF, RULE_REF, RULE_REF, arg, arg, op, op
                    // token labels: arg, op
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt63) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: rew2, predicated, rew, last, preds
                    // token labels: rew2
