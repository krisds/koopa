...
public class ArithmeticExpressionTest extends TestCase {
  ...
  private static koopa.grammars.cobol.CobolGrammar grammar = new koopa.grammars.cobol.CobolGrammar();
    ...
    public void testArithmeticExpression_2() {
      Parser parser = grammar.arithmeticExpression();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("42.0");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testArithmeticExpression_3() {
      Parser parser = grammar.arithmeticExpression();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("FORTY-TWO");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testArithmeticExpression_11() {
      Parser parser = grammar.arithmeticExpression();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("42 ** 7");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testArithmeticExpression_12() {
      Parser parser = grammar.arithmeticExpression();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("42.0 ** 7");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testArithmeticExpression_13() {
      Parser parser = grammar.arithmeticExpression();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("FORTY-TWO ** 7");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testArithmeticExpression_20() {
      Parser parser = grammar.arithmeticExpression();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("42 ** 7 ** ELEVENTY");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testArithmeticExpression_21() {
      Parser parser = grammar.arithmeticExpression();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("42.0 ** 7 ** ELEVENTY");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testArithmeticExpression_22() {
      Parser parser = grammar.arithmeticExpression();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("FORTY-TWO ** 7 ** ELEVENTY");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testArithmeticExpression_29() {
      Parser parser = grammar.arithmeticExpression();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("42 * ELEVENTY");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testArithmeticExpression_31() {
      Parser parser = grammar.arithmeticExpression();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("42 * ELEVENTY / 7");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testArithmeticExpression_39() {
      Parser parser = grammar.arithmeticExpression();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("42 * 7 + ELEVENTY / FORTY-TWO");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testArithmeticExpression_43() {
      Parser parser = grammar.arithmeticExpression();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("( 42 + ELEVENTY ) * ( 7 / FORTY-TWO )");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
}