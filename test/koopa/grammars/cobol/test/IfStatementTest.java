...
public class IfStatementTest extends TestCase {
  ...
  private static koopa.grammars.cobol.CobolGrammar grammar = new koopa.grammars.cobol.CobolGrammar();
    ...
    public void testIfStatement_1() {
      ...
      TestTokenizer tokenizer = new TestTokenizer("IF 1 < 2 THEN\n     DISPLAY GOOD \n   END-IF");
    ...
    public void testIfStatement_2() {
      Parser parser = grammar.ifStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("IF 1 < 2\n     DISPLAY GOOD\n   END-IF");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testIfStatement_19() {
      Parser parser = grammar.ifStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("IF 1 < 2 AND 2 > 1\n 		DISPLAY GOOD\n 	END-IF");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testIfStatement_20() {
      Parser parser = grammar.ifStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("IF 1 < 2 AND 2 > 1 AND V-ARIABLE = 0\n 		DISPLAY GOOD\n 	END-IF");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testIfStatement_21() {
      Parser parser = grammar.ifStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("IF V-ARIABLE = 2 OR = 3\n 	DISPLAY PERFECT\n 	END-IF");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testIfStatement_22() {
      Parser parser = grammar.ifStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("IF ( V-ARIABLE = 2 OR = 3 ) THEN\n 	DISPLAY PERFECT\n 	END-IF");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testIfStatement_23() {
      Parser parser = grammar.ifStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("IF ( V-ARIABLE = 2 OR = 3 ) AND V-ARIABLE NOT = 3\n 	DISPLAY PERFECT\n 	END-IF");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testIfStatement_24() {
      Parser parser = grammar.ifStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("IF V-ARIABLE NOT = 3 AND ( V-ARIABLE = 2 OR = 3 )\n 	DISPLAY PERFECT\n 	END-IF");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
}