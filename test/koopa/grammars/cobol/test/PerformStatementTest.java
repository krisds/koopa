...
public class PerformStatementTest extends TestCase {
  ...
  private static koopa.grammars.cobol.CobolGrammar grammar = new koopa.grammars.cobol.CobolGrammar();
    ...
    public void testUntil_4() {
      ...
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("UNTIL MY-COUNT > 42  KOOPAH_TO_HERE  .");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testUntil_5() {
      Parser parser = grammar.until();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("WITH TEST BEFORE UNTIL MY-COUNT > 42  KOOPAH_TO_HERE  .");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testUntil_6() {
      Parser parser = grammar.until();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("TEST BEFORE UNTIL MY-COUNT > 42  KOOPAH_TO_HERE  .");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testUntil_7() {
      Parser parser = grammar.until();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("WITH TEST AFTER UNTIL MY-COUNT > 42  KOOPAH_TO_HERE  .");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testUntil_8() {
      Parser parser = grammar.until();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("TEST AFTER UNTIL MY-COUNT > 42  KOOPAH_TO_HERE  .");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testVarying_9() {
      ...
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("VARYING MY-COUNT FROM LOWER BY STEP UNTIL MY-COUNT > UPPER  KOOPAH_TO_HERE  .");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testVarying_10() {
      Parser parser = grammar.varying();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("WITH TEST BEFORE\n   VARYING MY-COUNT\n   FROM LOWER\n   BY STEP\n   UNTIL MY-COUNT > UPPER  KOOPAH_TO_HERE  .");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testVarying_11() {
      Parser parser = grammar.varying();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("TEST BEFORE\n   VARYING MY-COUNT\n   FROM LOWER\n   BY STEP\n   UNTIL MY-COUNT > UPPER  KOOPAH_TO_HERE  .");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testVarying_12() {
      Parser parser = grammar.varying();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("WITH TEST AFTER\n   VARYING MY-COUNT\n   FROM LOWER\n   BY STEP\n   UNTIL MY-COUNT > UPPER  KOOPAH_TO_HERE  .");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testVarying_13() {
      Parser parser = grammar.varying();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("TEST AFTER\n   VARYING MY-COUNT\n   FROM LOWER\n   BY STEP\n   UNTIL MY-COUNT > UPPER  KOOPAH_TO_HERE  .");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testVarying_14() {
      Parser parser = grammar.varying();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("VARYING MY-COUNT FROM LOWER BY STEP UNTIL MY-COUNT > UPPER\n   AFTER OTHER-COUNT FROM A-1 BY A-2 UNTIL OTHER-COUNT > A-3  KOOPAH_TO_HERE  .");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testVarying_15() {
      Parser parser = grammar.varying();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("VARYING MY-COUNT FROM LOWER BY STEP UNTIL MY-COUNT > UPPER\n   AFTER OTHER-COUNT FROM A-1 BY A-2 UNTIL OTHER-COUNT > A-3\n   AFTER OTHER-COUNT FROM B-1 BY B-2 UNTIL OTHER-COUNT > B-3  KOOPAH_TO_HERE  .");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testPerformStatement_17() {
      Parser parser = grammar.performStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("PERFORM SUB-A THROUGH SUB-B");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testPerformStatement_22() {
      Parser parser = grammar.performStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("PERFORM\n     DISPLAY 1\n   END-PERFORM");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testPerformStatement_25() {
      Parser parser = grammar.performStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("PERFORM SUB-A THROUGH SUB-B 7 TIMES");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testPerformStatement_26() {
      Parser parser = grammar.performStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("PERFORM 7 TIMES\n     DISPLAY 1\n     DISPLAY 2\n     DISPLAY 3\n   END-PERFORM");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testPerformStatement_27() {
      Parser parser = grammar.performStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("PERFORM SUB-A UNTIL MY-COUNT > 42  KOOPAH_TO_HERE  .");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testPerformStatement_28() {
      Parser parser = grammar.performStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("PERFORM SUB-A THROUGH SUB-B UNTIL MY-COUNT > 42  KOOPAH_TO_HERE  .");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testPerformStatement_29() {
      Parser parser = grammar.performStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("PERFORM SUB-A THRU SUB-B UNTIL MY-COUNT > 42  KOOPAH_TO_HERE  .");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testPerformStatement_30() {
      Parser parser = grammar.performStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("PERFORM UNTIL MY-COUNT > 42\n     DISPLAY 1\n     DISPLAY 2\n     DISPLAY 3\n   END-PERFORM");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testPerformStatement_31() {
      Parser parser = grammar.performStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("PERFORM SUB-A\n     VARYING MY-COUNT FROM LOWER BY STEP UNTIL MY-COUNT > UPPER  KOOPAH_TO_HERE  .");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
