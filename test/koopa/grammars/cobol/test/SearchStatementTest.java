...
public class SearchStatementTest extends TestCase {
  ...
  private static koopa.grammars.cobol.CobolGrammar grammar = new koopa.grammars.cobol.CobolGrammar();
    ...
    public void testNotAtEnd_3() {
      ...
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("NOT AT END DISPLAY \"FOO\"");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testSearchStatement_5() {
      ...
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("SEARCH EMPLOYEES\n   WHEN TRUE\n        DISPLAY \"Found one.\"");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testSearchStatement_9() {
      Parser parser = grammar.searchStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("SEARCH EMPLOYEES VARYING EMPLOYEE-NUMBER\n   WHEN TRUE\n        DISPLAY \"Found one.\"");
      assertTrue(parser.accepts(tokenizer));
      assertTrue(tokenizer.isWhereExpected());
    }
    ...
    public void testSearchStatement_31() {
      Parser parser = grammar.searchStatement();
      assertNotNull(parser);
      TestTokenizer tokenizer = new TestTokenizer("SEARCH ALL EMPLOYEES VARYING EMPLOYEE-NUMBER\n   WHEN TRUE\n        DISPLAY \"Found one.\"");
